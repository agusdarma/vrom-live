                  ...
                  <div class="row col-mb-50">
                    ...
                    <div class="text-center col-md-7 text-md-start bg-light">
                      ...
                      <div id="sini" class="mt-4 heading-block">
                        <h2 class="text-black fw-bold">Pound Swing Master</h2>
                        <span>Pound Swing Master is a complete automated trading robot that has designed and create
based on artificial intelligence ( AI ).</span>
                      </div>

                      <p><b>Pound Swing Master</b> is a complete automated trading robot that has designed and create
...
intelligence makes decisions based on the past 400 or 500 candles</p>
                      ...
                      <a href="{{ route('front.checkout', $item->slug) }}" class="text-black button button-3d button-large bg-primary">Rent Now</a>                      

                    </div>
                  </div>  
                  <div class="mt-6 fancy-title title-border title-center">
                    <h3>Pound Swing Master Rates</h3>
                  </div>
                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-10">                        
                      ...
                      <h1 class="display-3 fw-normal" style="letter-spacing: -1px;">You can auto-trade with a robot which not only profitable, 
                        {{-- <div class="text-black badge bg-primary" style="width: 24rem;"> but also stable. </div>  --}}
                        but also stable.
                      </h1>
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            ...
                            <div class="carousel-caption d-none d-lg-block">
                              <h3 class="mb-2 text-black bg-primary" style="width: 12rem;">Backtest Result</h3>                           
                            </div>
                          </div>
                          <div class="carousel-item active">
                            <img class="h-auto d-block w-100" src="{{ url("build/assets/all/images/pound2.png")}}" alt="Trade Result">
                            <div class="carousel-caption d-none d-lg-block">
                              <h3 class="mb-2 text-black bg-primary" style="width: 12rem;">Trade Result</h3>                              
                            </div>
                          </div>
                          <div class="carousel-item active">
          ...
          <div class="container">
            <div class="row justify-content-between align-items-center">
              <div class="col-lg-auto">
                <strong><i class="bi-boxes"></i> Good News!</strong> Rent Pound Swing Expert NOW!
              </div>
              <div class="mt-3 col-lg-auto mt-lg-0">
                <a href="{{ route('front.checkout', $item->slug) }}" class="btn btn-primary">Rent Now</a>
