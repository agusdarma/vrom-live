...
intelligence makes decisions based on the past 400 or 500 candles</p>
                      ...
                      <a href="#" class="text-black button button-3d button-large bg-hijau-stabilo">Rent Now</a>
                      ...
                      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img class="h-auto d-block w-100" src="build/assets/all/images/euro-bt2.jpg" alt="Trade while Covid Delta">
                            <div class="carousel-caption d-none d-lg-block">
                              <h3 class="mb-2 text-black bg-hijau-stabilo" style="width: 18rem;">Trade while Covid Delta</h3>                              
                            </div>
                          </div>
                          <div class="carousel-item">
                            <img class="h-auto d-block w-100" src="build/assets/all/images/euro-bt1.jpg" alt="Backtest Result">
                            <div class="carousel-caption d-none d-lg-block">
                              <h3 class="mb-2 text-black bg-hijau-stabilo" style="width: 12rem;">Backtest Result</h3>                              
                            </div>
                          </div>
                          <div class="carousel-item">
                            <img class="h-auto d-block w-100" src="build/assets/all/images/euro-bt3.jpg" alt="Trade while Ukraine War">
                            <div class="carousel-caption d-none d-lg-block">
                              <h3 class="mb-2 text-black bg-hijau-stabilo" style="width: 20rem;">Trade while Ukraine War</h3>                              
                            </div>
                          </div>
                        </div>
          ...
          <div class="container">
            <div class="row justify-content-between align-items-center">
              <div class="col-lg-auto">
                <strong><i class="bi-boxes"></i> Good News!</strong> Rent Euro Swing Expert NOW!
              </div>
